...
User.create(
  first_name: 'Lizzie',
  last_name: 'B',
  email: 'lizziebennet@gmail.com',
  password: 'password',
  city: 'chicago',
  about: 'I like apples',
  gender: 'male',
  confirmed_at: '2017-10-17 02:26:15.130453',
  admin: true,
  superadmin: true,
